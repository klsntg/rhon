                      ...
                      <Line
                        data={{
                          ...
                          datasets: [{
                            ...
                            fill: false,
                            borderColor: determineBorderColor(chartData), // Use the function to determine the color
...
function determineBorderColor(data) {
  if (data.length < 2) return 'rgb(75, 192, 192)'; // Default color if less than 2 data points

  const lastPrice = data[data.length - 1].price;
  const secondLastPrice = data[data.length - 2].price;

  return lastPrice > secondLastPrice? 'green' : 'red'; // Green if price increased, red if decreased
}
